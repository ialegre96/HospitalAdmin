    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                @endif
                <div class="alert alert-danger display-none hide" id="ipdChargevalidationErrorsBox"></div>
                ...
                <div class="row">
                    <div class="form-group col-md-6 mb-0">
                        <div class="form-group mb-5">
                            ...
                            {{ Form::text('date', null, ['class' => 'form-control form-control-solid modelDataPickerzindex','id' => 'ipdChargeDate','autocomplete' => 'off', 'required']) }}
                        </div>
                    </div>
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        {{ Form::select('charge_type_id', $chargeTypes, null, ['class' => 'form-select form-select-solid select2Selector', 'id' => 'chargeTypeId', 'required','placeholder'=>'Select Charge Type', 'data-is-charge-edit' => false]) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        {{ Form::select('charge_category_id', [null], null, ['class' => 'form-select form-select-solid select2Selector', 'id' => 'chargeCategoryId', 'required', 'disabled', 'data-is-charge-edit' => 0, 'placeholder'=>'Select Charge Category']) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        {{ Form::select('charge_id', [null], null, ['class' => 'form-select form-select-solid select2Selector', 'id' => 'chargeId', 'required', 'disabled', 'data-is-charge-edit' => 0, 'placeholder'=>'Select Code']) }}
                    </div>
                    <div class="form-group col-md-6 mb-5">
                        <div class="form-group">
                            ...
                            {{ Form::text('standard_charge', null, ['class' => 'form-control form-control-solid price-input','id' => 'ipdStandardCharge', 'readonly']) }}
                        </div>
                    </div>
                    <div class="form-group col-md-6 mb-5">
                        <div class="form-group">
                            ...
                            {{ Form::text('applied_charge', null, ['class' => 'form-control form-control-solid price-input','id' => 'ipdAppliedCharge', 'required']) }}
                        </div>
                    </div>
                </div>
