            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        {{ Form::select('type_number', [null], null, ['class' => 'form-select form-select-solid select2Selector consultation-type-number', 'placeholder' => 'Select Type Number', 'disabled', 'required', 'data-control'=>'select2']) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
