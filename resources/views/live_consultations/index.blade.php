                        ...
                        <div
                            ...
                            <div class="menu-item px-5">
                                <a href="#" class="menu-link px-5" data-bs-toggle="modal"
                                   data-bs-target="#addModal">{{ __('messages.live_consultation.new_live_consultation') }}</a>
                            </div>
                            <div class="menu-item px-5">
                                <a href="#"
                                   class="menu-link px-5 add-credential">{{ __('messages.live_consultation.add_credential') }}</a>
                            </div>
                        </div>
