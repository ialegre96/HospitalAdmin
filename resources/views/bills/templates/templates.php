...
<tr>
    ...
    <td class="table__item-desc">
        <input class="form-control itemName form-control-solid" required="" name="item_name[]" type="text">
    </td>
    <td class="table__qty">
        <input class="form-control qty quantity form-control-solid" required="" name="qty[]" type="number">
    </td>
    <td>
