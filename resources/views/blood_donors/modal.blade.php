    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2>{{ __('messages.blood_donor.new_blood_donor') }}</h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('name', '', ['id'=>'name','class' => 'form-control form-control-solid','required']) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('age', __('messages.blood_donor.age').(':'),['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
                        {{ Form::number('age', '', ['id'=>'age','class' => 'form-control form-control-solid','required','min' => '1', 'max' => '100']) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                    ...
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::select('blood_group', $bloodGroup, null, ['class' => 'form-select form-select-solid select2Selector fw-bold', 'required', 'id' => 'bloodGroup', 'placeholder' => 'Select Blood Group', 'data-control' => 'select2', 'required']) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('last_donate_date', '', ['id'=>'lastDonationDate','class' => 'form-control form-control-solid','required', 'autocomplete' => 'off']) }}
                    </div>
                </div>
