        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group mb-5">
                            {{ Form::label('description', __('messages.operation_report.description').(':'), ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
                            {{ Form::textarea('description', null, ['class' => 'form-control form-control-solid','id' => 'editDescription', 'rows' => 5]) }}
                        </div>
                    </div>
