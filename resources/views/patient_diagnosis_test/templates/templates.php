...
<tr>
    <td class="text-center item-number">1</td>
     <td>
        <input class="form-control diagnosis-name form-control-solid" name="property_name[]" type="text" data-id="{{:uniqueId}}">
    </td>
    <td>
        <input class="form-control diagnosis-value form-control-solid" name="property_value[]" type="text">
    </td>
    </td>
    <td class="text-center">
    <a href="javascript:void(0)" title="<?php echo __('messages.common.delete') ?>" class="delete-diagnosis pointer btn btn-icon btn-bg-light btn-active-color-danger btn-sm">
                        <span class="svg-icon svg-icon-3">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <rect x="0" y="0" width="24" height="24" />
