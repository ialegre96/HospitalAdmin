    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2>{{ __('messages.hospital_blood_bank.edit_blood_group') }}</h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('blood_group', null, ['id'=>'editBloodGroup','class' => 'form-control form-control-solid','required']) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::number('remained_bags', '', ['id'=>'editRemainedBags','class' => 'form-control form-control-solid','required', 'min' => 1]) }}
                    </div>
