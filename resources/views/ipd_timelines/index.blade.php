            ...
            <div class="timeline-item" date-is="{{ date('jS M, Y', strtotime($ipdTimeline->date)) }}">
                <div class="float-end bottom-sm mb-5">
                    @if($ipdTimeline->ipd_timeline_document_url != '')
                        <a title="download" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 "
                    ...
                    @if(Auth::user()->hasRole('Admin'))
                        ...
                        <a title="<?php echo __('messages.common.edit') ?>" data-timeline-id="{{ $ipdTimeline->id }}"
                           class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 edit-timeline-btn">
                    <span class="svg-icon svg-icon-3">
                        ...
                        <a href="#" title="<?php echo __('messages.common.delete') ?>"
                           ...
                           class="delete-timeline-btn btn btn-icon btn-bg-light btn-active-color-danger btn-sm">
                        <span class="svg-icon svg-icon-3">
