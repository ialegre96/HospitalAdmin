                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6113c71822d0d">
                            ...
                            <div class="px-7 py-5">
                                ...
                                <div class="mb-10">
                                    ...
                                    {{ Form::select('department_id',['' => 'Select Role'] +$roles,null, ['id' => 'roleArr', 'data-control' =>'select2', 'class' => 'form-select form-select-solid role-selector',]) }}
                                </div>
                                <div class="d-flex justify-content-end">
                                    <button type="reset" class="btn btn-sm btn-light btn-active-light-primary me-2" id="resetFilter"
