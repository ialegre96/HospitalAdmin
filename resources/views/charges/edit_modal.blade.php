    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2>{{ __('messages.charge.edit_charge') }}</h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::select('charge_type', $chargeTypes, null, ['class' => 'form-select form-select-solid','required','id' => 'editChargeTypeId','placeholder' => 'Select Charge Type']) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::select('charge_category_id', (isset($chargeCategory) ? $chargeCategory : []), null, ['class' => 'form-select form-select-solid','required','id' => 'editChargeCategoryId','placeholder' => 'Select Charge Category']) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('code', __('messages.charge.code').(':'), ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
                        {{ Form::text('code', null, ['class' => 'form-control form-control-solid','required','id' => 'editCode']) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('standard_charge', null, ['class' => 'form-control price-input form-control-solid','required', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")' , 'id' =>'editStdCharge']) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
