    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{__('messages.service_slider.add_service_slider')}}</h5>
                        ...
                        <div class="row2">
                            <label class="form-label required fs-6 fw-bolder text-gray-700 mb-3 d-block"
                                ...
                                <i class="fa fa-question-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                   title="Best resolution for this image will be 140x50"></i>
                            </label>
                            <div id="inputImage" class="image-input image-input-outline" data-kt-image-input="true">
                            ...
                            <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow"
                                ...
                                {{ Form::file('img_url',['id' => 'serviceImage','class' => 'd-none','accept' => '.png, .jpg, .jpeg, .svg']) }}
            ...
            <div class="text-right mt-5">
                <button type="submit" class="btn btn-primary me-3"
                        id="testimonialSaveBtn">{{__('messages.common.save')}}</button>
