...
<tr>
    <td class="text-center item-number">1</td>
     <td>
        <input class="form-control disease-name form-control-solid" required="" name="disease_name[]" type="text" data-id="{{:uniqueId}}">
    </td>
    <td>
        <input class="form-control disease-charge price-input form-control-solid" required="" name="disease_charge[]" type="text">
    </td>
    </td>
    <td class="text-center">
     <a href="#" title="<?php echo __('messages.common.delete') ?>"  class="delete-btn delete-disease pointer btn btn-icon btn-bg-light btn-active-color-danger btn-sm">
