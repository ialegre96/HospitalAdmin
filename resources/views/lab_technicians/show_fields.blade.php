                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        <div class="d-flex flex-column">
                            <div class="d-flex align-items-center mb-2">
                                <a href="#"
                                   class="text-gray-800 text-hover-primary fs-2 fw-bolder me-4">{{$labTechnician->user->full_name}}</a>
                                <span
                                    class="badge badge-light-{{ $labTechnician->user->status === 1 ? 'success' : 'danger' }} fw-bolder ms-2 fs-8 py-1 px-3">{{ ($labTechnician->user->status === 1) ? __('messages.common.active') : __('messages.common.de_active') }}</span>
                            </div>
                ...
                <div>
                    <div class="card-body  border-top p-9">
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <span class="fw-bolder fs-6 text-gray-800">{{!empty($labTechnician->user->phone)?$labTechnician->user->phone:'N/A'}}</span>
                            </div>
                        </div>
                        <div class="row mb-7">
                            <label class="col-lg-4 fw-bold text-muted">{{ __('messages.user.gender')  }}</label>
                            <div class="col-lg-8">
                                <span class="fw-bolder fs-6 text-gray-800">{{ $labTechnician->user->gender == 0 ? 'Male' : 'Female' }}</span>
                            </div>
                        </div>
                        <div class="row mb-7">
                            <label class="col-lg-4 fw-bold text-muted">{{ __('messages.user.blood_group')  }}</label>
                            <div class="col-lg-8">
                                <span class="fs-6 badge badge-light-{{!empty($labTechnician->user->blood_group) ? 'success' : 'danger'}}">{{ !empty($labTechnician->user->blood_group) ? $labTechnician->user->blood_group : __('messages.common.n/a') }}</span>
                            </div>
                        </div>
                        <div class="row mb-7">
                            <label class="col-lg-4 fw-bold text-muted">{{ __('messages.user.dob')  }}</label>
                            <div class="col-lg-8">
                                <span class="fw-bolder fs-6 text-gray-800">{{ !empty($labTechnician->user->dob) ? \Carbon\Carbon::parse($labTechnician->user->dob)->format('jS M, Y') : __('messages.common.n/a') }}</span>
                            </div>
                        </div>
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <span
                                    class="fw-bolder fs-6 text-gray-800">{{ !empty($labTechnician->user->designation) ? $labTechnician->user->designation : __('messages.common.n/a') }}</span>
                            </div>
                        </div>
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <span
                                    class="fw-bolder fs-6 text-gray-800">{{ !empty($labTechnician->user->qualification) ? $labTechnician->user->qualification : __('messages.common.n/a')}}</span>
                            </div>
                        </div>
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <span
                                    class="fw-bolder fs-6 text-gray-800 me-2">{{ !empty($labTechnician->user->created_at) ? $labTechnician->user->created_at->diffForHumans() : __('messages.common.n/a') }}</span>
                            </div>
                        </div>
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <span
                                    class="fw-bolder fs-6 text-gray-800 me-2">{{ !empty($labTechnician->user->updated_at) ? $labTechnician->user->updated_at->diffForHumans() : __('messages.common.n/a') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="table-responsive viewList">
                                    ...
                                    <table id="labTechnicianPayrolls" class="display table table-responsive-sm table-striped align-middle table-row-dashed fs-6 gy-5 gx-5 dataTable no-footer w-100">
                                        <thead>
                                        ...
                                        @foreach($payrolls as $payroll)
                                            <tr>
                                                <td class="text-center"><a href="{{url('employee-payrolls', $payroll->id)}}"><span class="badge badge-light-info fs-6">{{ $payroll->payroll_id }}</span></a></td>
                                                <td>{{ $payroll->month }}</td>
                                                <td>{{ $payroll->year }}</td>
                                                <td class="text-right">
