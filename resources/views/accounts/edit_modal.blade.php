...
{{--                <div class="alert alert-danger display-none hide" id="editValidationErrorsBox1">--}}
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12 mb-5">
                            ...
                            {{ Form::textarea('description', null, ['class' => 'form-control form-control-solid','id'=>'editDescription', 'rows' => 4]) }}
                        </div>
