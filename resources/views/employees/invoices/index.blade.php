                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
                            ...
                            <div class="px-7 py-5">
                                <div class="mb-10">
                                    ...
                                    {{ Form::select('status', $statusArr,null, ['id' => 'status_filter', 'data-control' =>'select2', 'class' => 'form-select form-select-solid status-selector status-filter select2-hidden-accessible data-allow-clear="true"']) }}
                                </div>
