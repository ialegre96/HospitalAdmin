        ...
        <div class="m-0">
            ...
            <div class="row g-5 mb-11">
                ...
                <div class="col-sm-3">
                    ...
                    <div
                        class="fw-bolder fs-6 text-gray-800">{{ Carbon\Carbon::parse($bill->bill_date)->format('jS M, Y g:i A') }}</div>
                </div>
                <div class="col-sm-3">
                ...
                <div class="col-sm-3">
                    ...
                    <div
                        class="fw-bolder fs-6 text-gray-800">{{ !empty($bill->patient->user->email) ? $bill->patient->user->email : __('messages.common.n/a') }}</div>
                </div>
            </div>
            <div class="row g-5 mb-11">
                <div class="col-sm-3">
                    ...
                    <div
                        class="fw-bolder fs-6 text-gray-800">{{ !empty($bill->patient->user->phone) ? $bill->patient->user->phone : __('messages.common.n/a') }}</div>
                </div>
                <div class="col-sm-3">
                    <div class="fw-bold fs-7 text-gray-600 mb-1">{{ __('messages.bill.patient_gender').':' }}</div>
                    <div
                        class="fw-bolder fs-6 text-gray-800">{{ (!$bill->patient->user->gender) ? __('messages.user.male') : __('messages.user.female') }}</div>
                </div>
                <div class="col-sm-3">
                    <div class="fw-bold fs-7 text-gray-600 mb-1">{{ __('messages.bill.patient_dob').':' }}</div>
                    <div
                        class="fw-bolder fs-6 text-gray-800">{{ (!empty($bill->patient->user->dob)) ? \Carbon\Carbon::parse($bill->patient->user->dob)->format('jS M, Y') : __('messages.common.n/a') }}</div>
                </div>
                <div class="col-sm-3">
                    <div class="fw-bold fs-7 text-gray-600 mb-1">{{ __('messages.case.doctor').':' }}</div>
                    <div
                        class="fw-bolder fs-6 text-gray-800">{{ $bill->patientAdmission->doctor->user->full_name }}</div>
                </div>
            </div>
            <div class="row g-5 mb-11">
                <div class="col-sm-3">
                    ...
                    <div
                        class="fw-bolder fs-6 text-gray-800">{{ \Carbon\Carbon::parse($bill->patientAdmission->admission_date)->format('jS M, Y g:i A') }}</div>
                </div>
                <div class="col-sm-3">
                    <div class="fw-bold fs-7 text-gray-600 mb-1">{{ __('messages.bill.discharge_date').':' }}</div>
                    <div
                        class="fw-bolder fs-6 text-gray-800">{{ !empty($bill->patientAdmission->discharge_date) ? date('jS M, Y g:i A', strtotime($bill->patientAdmission->discharge_date)) : __('messages.common.n/a') }}</div>
                </div>
                <div class="col-sm-3">
                    <div class="fw-bold fs-7 text-gray-600 mb-1">{{ __('messages.bill.package_name').':' }}</div>
                    <div
                        class="fw-bolder fs-6 text-gray-800">{{ !empty($bill->patientAdmission->package->name) ? $bill->patientAdmission->package->name : __('messages.common.n/a') }}</div>
                </div>
                <div class="col-sm-3">
                    <div class="fw-bold fs-7 text-gray-600 mb-1">{{ __('messages.bill.insurance_name').':' }}</div>
                    <div
                        class="fw-bolder fs-6 text-gray-800">{{ !empty($bill->patientAdmission->insurance->name) ? $bill->patientAdmission->insurance->name: __('messages.common.n/a') }}</div>
                </div>
            </div>
            <div class="row g-5 mb-11">
                <div class="col-sm-3">
                ...
                <div class="col-sm-3">
                    ...
                    <div
                        class="fw-bolder fs-6 text-gray-800">{{ !empty($bill->patientAdmission->policy_no) ? $bill->patientAdmission->policy_no : __('messages.common.n/a') }}</div>
                </div>
                <div class="col-sm-3">
                ...
                <div class="d-flex justify-content-end">
                    <div class="mw-300px">
                        <div class="d-flex flex-stack">
                            ...
                            <div
                                class="text-end fw-bolder fs-6 text-gray-800">{{ getCurrencySymbol()}}  {{ number_format($bill->amount,2) }}</div>
                        </div>
                    </div>
                </div>
            </div>
