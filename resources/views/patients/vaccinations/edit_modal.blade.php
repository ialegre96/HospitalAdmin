            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        {{ Form::select('patient_id', $vaccinationPatients, null, ['class' => 'form-select form-select-solid fw-bold', 'id' => 'editPatientName','placeholder' => 'Select Patient Name', 'required']) }}
                    </div>

                    <div class="form-group col-sm-6 mb-5">
                        {{ Form::label('vaccination_id', __('messages.vaccinated_patient.vaccination').(':'), ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
                        {{ Form::select('vaccination_id', $vaccinations, null, ['class' => 'form-select form-select-solid fw-bold', 'id' => 'editVaccinationName','placeholder' => 'Select Vaccination', 'required']) }}
                    </div>
                    ...
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('vaccination_serial_number', '', ['id'=>'editSerialNo','class' => 'form-control form-control-solid']) }}
                    </div>
                    ...
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        {{ Form::number('dose_number', '', ['id'=>'editDoseNumber','class' => 'form-control form-control-solid','min'=>'1','max'=>'50','minlength'=>'1','maxlength'=>'2','required']) }}
                    </div>
                    ...
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        {{ Form::text('dose_given_date', '', ['id'=>'editDoesGivenDate','class' => 'form-control form-control-solid','required','autocomplete' => 'off']) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
