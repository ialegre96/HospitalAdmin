    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2>{{ __('messages.radiology_category.new_radiology_category') }}</h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('name', __('messages.radiology_category.name').':', ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
