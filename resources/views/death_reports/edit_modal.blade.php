    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2>{{ __('messages.death_report.edit_death_report') }}</h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::select('case_id', $cases, null, ['class' => 'form-select form-select-solid','required','id' => 'editCaseId','placeholder'=>'Select Case']) }}
                    </div>
                    ...
                    @else
                        <div class="form-group col-sm-12 mb-5">
                            ...
                            {{ Form::select('doctor_id',$doctors, null, ['class' => 'form-select form-select-solid','required','id' => 'editDoctorId','placeholder'=>'Select Doctor']) }}
                        </div>
                    @endif
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('date', __('messages.death_report.date').(':'), ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
                        {{ Form::text('date', null, ['id'=>'editDate', 'class' => 'form-control form-control-solid', 'required','autocomplete' => 'off']) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('description', __('messages.death_report.description').(':'), ['class' => 'form-label fs-6 fw-bolder text-gray-700 mb-3']) }}
