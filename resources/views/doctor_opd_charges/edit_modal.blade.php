    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2>{{ __('messages.doctor_opd_charge.edit_doctor_opd_charge') }}</h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-5">
                        ...
                        {{ Form::select('doctor_id',$doctors, null, ['class' => 'form-select form-select-solid', 'autocomplete' => 'off', 'required','id' => 'editDoctorId','placeholder'=>'Select Patient']) }}
                    </div>
                    <div class="col-md-12 mt-3 mb-5">
                        ...
                        {{ Form::text('standard_charge', null, ['class' => 'form-control price-input form-control-solid', 'required', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'id' => 'editStandardCharge']) }}
                    </div>
