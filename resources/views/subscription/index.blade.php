...
@section('content')
    ...
    <div class="card">
        <div class="card-header border-0 pt-6">
            ...
            {{--                                </div>--}}
            {{--                                <div class="mb-10">--}}
            {{--                                    <label class="form-label fs-6 fw-bold">{{ __('messages.subscription_plans.frequency').':' }}</label>--}}
            {{--                                    {{ Form::select('frequency',['' => 'All'] + $planType,null, ['id' => 'frequencyArr', 'data-control' =>'select2', 'class' => 'form-select form-select-solid status-selector select2-hidden-accessible data-allow-clear="true"']) }}--}}
            {{--                                </div>--}}
        ...
        @include('subscription.templates.templates')
    </div>
@endsection
@section('scripts')
    <script>
