        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                ...
                <span class="svg-icon svg-icon-5 svg-icon-gray-500 me-1">
                    ...
                    <a href="{{ route('super.admin.subscription.plans.create') }}"
                       class="btn btn-primary">{{ __('messages.subscription_plans.add_subscription_plan') }}</a>
                </div>
            </div>
        </div>
        <div class="card-body pt-0 fs-6 py-8 px-8 px-lg-10 text-gray-700">
            @include('super_admin.subscription_plans.table')
        </div>
        @include('super_admin.subscription_plans.templates.templates')
    </div>
@endsection
@section('scripts')
    <script>
