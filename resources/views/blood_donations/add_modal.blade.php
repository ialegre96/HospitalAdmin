    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2>{{ __('messages.blood_donation.new_blood_donation') }}</h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::select('blood_donor_id', $donorName, null, ['class' => 'form-select form-select-solid fw-bold select2Selector', 'required', 'id' => 'donorName', 'placeholder' => 'Select Donor Name', 'data-control' => 'select2', 'required']) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('bags', __('messages.blood_donation.bags').(':'),['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
                        {{ Form::number('bags', 1, ['id'=>'bags','class' => 'form-control form-control-solid','required','min' => 1, 'max' => 100]) }}
                    </div>
                </div>
