        ...
        _scrollIntoView: function (item) {
            ...
            if (this._hasScroll()) {
                ...
                paddingTop = parseFloat(
                    $.css(this.activeMenu[0], 'paddingTop')) || 0;
	 ...
	 */
        ...
        _checkOffset: function (inst, offset, isFixed) {
            ...
            offset.top -= (isFixed && offset.top ===
                (inst.input.offset().top + inputHeight)) ? $(document).
                scrollTop() : 0;
                    ...
                    for (dRow = 0; dRow < numRows; dRow++) { // create date picker rows
                        ...
                        for (dow = 0; dow < 7; dow++) { // create date picker days
                            ...
                            tbody += '<td class=\'' +
                                ...
                                ((printDate.getTime() ===
                                    selectedDate.getTime() && drawMonth ===
            ...
            $.each(draggable.sortables, function () {
                ...
                if (innermostIntersecting) {
                    ...
                    if (!sortable.isOver) {
                        ...
                        sortable.currentItem = ui.helper.appendTo(
                            sortable.element).data('ui-sortable-item', true);
                ...
                function () {
                    ...
                    if (this.options.greedy) {
                        ...
                        parent = this.element.parents(':data(ui-droppable)').
                            filter(function () {
                                return $(this).
                                        droppable('instance').options.scope ===
                                    scope;
                            });
        ...
        _drawMenu: function () {
            ...
            this.menuInstance = this.menu.menu({
                ...
                focus: function (event, ui) {
                    ...
                    if (that.focusIndex != null && item.index !==
                        that.focusIndex) {
    ...
    var slider = $.widget('ui.slider', $.ui.mouse, {
        ...
        _calculateNewMax: function () {
            var max = this.options.max,
                ...
                aboveMin = Math.floor(
                    (+(max - min).toFixed(this._precision())) / step) * step;
            max = aboveMin + min;
    ...
    var sortable = $.widget('ui.sortable', $.ui.mouse, {
        ...
        _mouseStop: function (event, noPropagation) {
            ...
            if (this.options.revert) {
                ...
                this.reverting = true;
                $(this.helper).
                    animate(animation, parseInt(this.options.revert, 10) || 500,
                        function () {
                            that._clear(event);
                        });
            } else {
        ...
        _intersectsWithPointer: function (item) {
            ...
            var isOverElementHeight = (this.options.axis === 'x') ||
                    this._isOverAxis(this.positionAbs.top + this.offset.click.top,
                    ...
                    update: function (container, p) {
                        ...
                        if (!p.height()) {
                            p.height(that.currentItem.innerHeight() - parseInt(
                                    that.currentItem.css('paddingTop') || 0, 10) -
                                parseInt(
                        ...
                        if (!p.width()) {
                            p.width(that.currentItem.innerWidth() - parseInt(
                                    that.currentItem.css('paddingLeft') || 0, 10) -
                                parseInt(
                ...
                if (o.grid) {
                    ...
                    pageX = this.containment ? ((left -
                        ...
                        : ((left - this.offset.click.left >=
                            this.containment[0]) ? left - o.grid[0] : left +
                            o.grid[0])) : left;
                }
 ...
 */
    ...
    var spinner = $.widget('ui.spinner', {
        ...
        _draw: function () {
            var uiSpinner = this.uiSpinner = this.element.addClass(
                'ui-spinner-input').
                attr('autocomplete', 'off').
