...
Route::post('/language-change-name', 'Web\WebController@languageChangeName');
...
//Theme-Mode
Route::get('theme-mode','UserController@changeThemeMode')->name('theme.mode');
...
Route::group([
    ...
    function () {
        ...
        Route::get('stripe-payment-success', 'StripeController@paymentSuccess')->name('payment-success');
...
Route::group([
    ...
    Route::get('income-chart', 'HomeController@incomeChart')->name('super.admin.income.chart');
...
Route::get('/upgrade-to-v1-1-1', function () {
    Artisan::call('db:seed', ['--class' => 'AddFieldSubscriptionPlanFeaturesTableSeeder']);
});
